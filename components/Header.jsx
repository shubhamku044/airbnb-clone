	...
	return (
		<header className="sticky top-0 left-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
			...
			<div className="flex items-center md:border-2 rounded-full py-2 md:shadow-sm">
				...
				/>
				<SearchIcon className="hidden md:inline-flex h-8 w-auto cursor-pointer bg-red-400 text-white rounded-full p-2 flex-shrink-0 md:mx-2" />
			</div>
			...
			{searchInput && (
				<div className="flex flex-col col-span-3 mx-auto">
					...
					<div className="flex">
						...
						<button className="flex-grow text-red-400 font-medium">
							Select
						</button>
					</div>
				</div>
